...
export default function EduNavbar() {
  ...
  // Auto close modal after login/signup
  useEffect(() => {
    if (user) {
...
>
  ...
  Profile
                      ...
                      >
                        <BiLogOut style={{ marginRight: "6px" }} />
                        Logout
                      </button>
                    </div>
                  )}
      ...
      <Modal show={showLogin} onHide={() => setShowLogin(false)} centered>
        ...
        <Modal.Body>
          {loginMsg && (
            <div
              className={`modal-message ${loginMsg.includes("Welcome") ? "success" : "error"
                }`}
            >
              {loginMsg}
            </div>
  ...
  <button className="auth-btn" disabled={loginSubmitting}>
    {loginSubmitting ? "Logging in..." : "Login"}
      ...
      <Modal show={showSignup} onHide={() => setShowSignup(false)} centered>
        ...
        <Modal.Body>
          ...
          {signupMsg && (
            <div
              className={`modal-message ${signupMsg.includes("exists") ? "error" : "success"
                }`}
            >
              {signupMsg}
            </div>
