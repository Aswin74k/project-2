...
<section className="paths-section">
  <Container>
    ...
    <p className="section-subtitle">
      Structured learning journeys designed to take you from fundamentals to
      real-world skills.
    </p>
    ...
    <Row>
      <Col lg={3} md={6} className="mb-4">
        <div className="path-card">
          ...
          <p>Build modern, responsive user interfaces.</p>
          <ul>
            <li>HTML, CSS, JavaScript</li>
            <li>React & UI Libraries</li>
            <li>Responsive Design</li>
          </ul>
          <span className="path-outcome">Outcome: UI Developer</span>
        </div>
      </Col>
      ...
      <Col lg={3} md={6} className="mb-4">
        <div className="path-card">
          ...
          <span className="path-outcome">Outcome:Full Stack Engineer</span>
        </div>
      </Col>
      ...
      <Col lg={3} md={6} className="mb-4">
        <div className="path-card">
          ...
          <span className="path-outcome">Outcome: UI/UX Designer</span>
        </div>
      </Col>
      ...
      <Col lg={3} md={6} className="mb-4">
        <div className="path-card">
          <h4>Data & AI Path</h4>
          <p>Learn data-driven and AI fundamentals.</p>
          <ul>
            <li>Python & Analytics</li>
            <li>Machine Learning Basics</li>
            <li>Real Data Projects</li>
          </ul>
          <span className="path-outcome">Outcome: Data Professional</span>
        </div>
      </Col>
    </Row>
  </Container>
