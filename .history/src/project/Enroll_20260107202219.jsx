...
export default function Enroll() {
 ...
 const onSubmit = () => {
  ...
  if (course) {
    enrollCourse(course); // 🔥 CONTEXT handles everything
  }
  ...
  if (loggedUser && course) {
    const enrolledCourses =
      loggedUser.enrolledCourses || [];

    // 🚫 Duplicate enroll avoid
