...
<section className="placement-section">
  <Container>
    ...
    <Row className="placement-content">
      <Col md={6}>
      ...
      <Col md={6}>
        <h4>Hiring & Industry Support</h4>
        <ul className="placement-list">
          <li>Real-world project experience</li>
          <li>Hiring partner referrals</li>
          <li>Internship & entry-level opportunities</li>
          <li>Continuous mentorship after course completion</li>
        </ul>
      </Col>
    </Row>
  </Container>
...
<footer className="footer">
  <Container>
    <Row className="footer-top">
      ...
      <Col md={4} className="footer-brand">
        ...
        <p className="footer-tagline">
          Empowering careers through industry-ready technology education,
    ...
    {/* Copyright */}
    <p className="copy">
      © 2025 TechMentor. All rights reserved.
    </p>
  </Container>
</footer>
