...
export default function Enroll() {
  ...
  // Course object passed from Course page
      ...
      <div className="enroll-layout">
        ...
        <div className="enroll-info">
          ...
          <p className="course-desc">
            {course?.description ||
              "This course is designed to help you build real-world skills with expert guidance and hands-on practice."}
          </p>
        ...
        <div className="enroll-container">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <button className="enroll-btn">Proceed to Payment →</button>
