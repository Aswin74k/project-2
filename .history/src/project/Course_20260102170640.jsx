  ...
  export default function Course() {
    ...
    const handleEnroll = () => {
      ...
      if (user) navigate("/enroll", { state: { courseId: id } });
      else window.dispatchEvent(new CustomEvent("showLoginModal"));
    };
      ...
      <div className="course-container">
        ...
        <section className="course-header">
          <div className="course-hero">
            ...
            <div className="course-stats">
              <div><span>Duration</span><h3>{course.duration}</h3></div>
              <div><span>Fee</span><h3>{course.fee}</h3></div>
              <div><span>Level</span><h3>Beginner → Advanced</h3></div>
            </div>
        ...
        <div className="course-content">
          <div className="info-box">
            ...
            <p>
              Learn <b>{course.title}</b> with hands-on projects, expert mentors,
              and industry-aligned curriculum designed for working professionals.
            </p>
          </div>
