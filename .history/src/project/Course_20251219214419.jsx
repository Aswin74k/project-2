    ...
    <div className="course-container">
      ...
      <div className="course-content">
        ...
        <div className="info-box">
          ...
          <p>
            Our <b>{course.title}</b> program helps learners gain industry-ready
            skills through structured modules, hands-on labs, and real-time
            projects guided by experts.
          </p>
        </div>
