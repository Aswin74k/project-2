  ...
  return (
    <div className="course-container">
      <div className="course-header">
        {/* ONLY ENROLL BUTTON – BACK REMOVED */}
      ...
      <div className="course-content container">
        <div className="info-box">
          ...
          <p>
            Our <b>{course.title}</b> program is designed to make you job-ready
            through hands-on training, real-world projects, and expert mentorship.
          </p>
        </div>

        <div id="syllabus" className="syllabus-box">
          <h3>Syllabus</h3>
          <ul>
