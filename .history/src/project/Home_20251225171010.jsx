...
<section className="placement-section">
  <Container>
    ...
    <p className="section-subtitle">
      Our alumni are placed in top tech companies across India and abroad.
    </p>

    <div className="placement-logos">
      <div className="logo-card">Google</div>
      <div className="logo-card">Amazon</div>
      <div className="logo-card">Microsoft</div>
      <div className="logo-card">Infosys</div>
      <div className="logo-card">TCS</div>
      <div className="logo-card">Wipro</div>
      <div className="logo-card">Zoho</div>
      <div className="logo-card">Accenture</div>
    </div>

    <div className="placement-note">
      * Placement support includes resume building, mock interviews, and career guidance.
    </div>
  </Container>
</section>
