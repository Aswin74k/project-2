    ...
    <>
      ...
      >        <Modal.Header closeButton>
        ...
        <Modal.Body>
          {loginMsg && (
            <div
              className={`modal-message ${loginMsg.toLowerCase().includes("welcome")
                  ? "success"
                  : "error"
                }`}
            >
      ...
      >
        ...
        <Modal.Body>
          {signupMsg && (
            <div
              className={`modal-message ${signupMsg.toLowerCase().includes("success")
                  ? "success"
                  : "error"
                }`}
            >
          ...
          <Form onSubmit={handleSignupSubmit(onSignupSubmit)} noValidate>
            ...
            <div className="password-wrapper mt-2">
              <input
                ...
                placeholder="Confirm password" au
